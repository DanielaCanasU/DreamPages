...
#Directoriodatapreprocesado = r"C:\Users\gabog\Downloads\DatasetPreprocesado.csv"
datapreprocesado = pd.read_csv('DatasetPreprocesado.csv')
...
#DirectorioEncontrarDescipcion = r"C:\Users\gabog\Downloads\Pagina_funcional_bonitaPorfavorFunciona\Pagina_funcional_bonita\my-app\api\books_cleaned_descripcion_char_places.csv"
EncontrarDescipcion = pd.read_csv('books_cleaned_descripcion_char_places.csv')
EncontrarDescipcion = datapreprocesado[["title", "description"]]
#---------------------------------------------------PARA EL RECOMENDADOR DE IMAGENES---------------------------------------------------
#Si quisiera solamente pasarle un solo titulo, se coloca solamente el titulo del libro en la prediccion y listo
...
def recomendadoraimagen(recommended_books):
    ...
    for book in recommended_books:
        ...
        for idx in range(3):
            ...
            image_filename = f"{book.replace(' ', '_')}_{idx + 1}.png"
            image_path = os.path.join(generated_images_dir, image_filename)

            # Verificar si la imagen ya existe
            if os.path.exists(image_path):
                print(f"Imagen existente encontrada: {image_path}")
